...
trait ConfigurationEndpoints[F[*]] {
  ...
  /** This API gathers configuration information about a service. <br> <details>
    ...
    * within the implementation of the configuration endpoint of the service
    * where the service that supports OpenID Connect and [OpenID Connect
    ...
    * the format are described in \"[3. OpenID Provider
    * Metadata](https://openid.net/specs/openid-connect-discovery-1_0.html#ProviderMetadata)\"
    * in OpenID Connect Discovery 1.0. </details>
    *
    * Expected answers: code 200 : Any () code 400 : Result () code 401 : Result
