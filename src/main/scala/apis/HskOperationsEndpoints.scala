...
trait HskOperationsEndpoints[F[*]] {
  ...
  /** Expected answers: code 200 : HskCreateResponse () code 400 : Result ()
  ...
  /** Expected answers: code 204 : HskDeleteResponse code 400 : Result () code
  ...
  /** Expected answers: code 200 : HskGetResponse () code 400 : Result () code
    * 401 : Result () code 403 : Result () code 500 : Result ()
    *
    * Available security schemes: ServiceOwnerCredentials (http)
    *
  ...
  /** Expected answers: code 200 : HskGetListResponse code 400 : Result () code
    * 401 : Result () code 403 : Result () code 500 : Result ()
    *
    * Available security schemes: ServiceOwnerCredentials (http)
    */
