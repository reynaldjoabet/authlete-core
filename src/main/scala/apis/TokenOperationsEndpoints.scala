...
trait TokenOperationsEndpoints[F[*]] {
  ...
  /** Create an access token.
    *
    * Expected answers: code 200 : TokenCreateResponse () code 400 : Result ()
  ...
  /** Delete an access token.
    *
    * Expected answers: code 204 : (The access token was successfully deleted. )
    ...
    *   The identifier of an existing access token. The identifier is the value
    *   of the access token or the value of the hash of the access token.
    */
  def authTokenDelete(
  ...
  /** Get the list of access tokens that are associated with the service.
    *
    * Expected answers: code 200 : TokenGetListResponse () code 400 : Result ()
    * code 401 : Result () code 403 : Result () code 500 : Result ()
    *
    * Available security schemes: ServiceCredentials (http)
    *
  ...
  /** Revoke an access token.
    *
    * Expected answers: code 200 : TokenRevokeResponse () code 400 : Result ()
    * code 401 : Result () code 403 : Result () code 500 : Result ()
    *
    * Available security schemes: ServiceCredentials (http)
    *
  ...
  /** Update an access token.
    *
    * Expected answers: code 200 : TokenUpdateResponse () code 400 : Result ()
    * code 401 : Result () code 403 : Result () code 500 : Result ()
    *
    * Available security schemes: ServiceCredentials (http)
    *
