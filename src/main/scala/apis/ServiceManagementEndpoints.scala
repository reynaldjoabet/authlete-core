...
trait ServiceManagementEndpoints[F[*]] {
  ...
  /** Create a new service.
    *
    * Expected answers: code 200 : Service () code 400 : Result () code 401 :
  ...
  /** Delete a service.
    *
    * Expected answers: code 204 : (The service was successfully deleted.) code
  ...
  /** Get a list of services.
    *
    * Expected answers: code 200 : ServiceGetListResponse () code 400 : Result
...
class ServiceManagementEndpointsImpl[F[*]: Concurrent](
  ...
  override def serviceGetList(
      start: Option[Int],
      end: Option[Int]
  ): F[ServiceGetListResponse] = ???

  override def serviceUpdate(
      serviceApiKey: String,
