...
trait ClientExtensionEndpoints[F[*]] {
  ...
  /** Delete a requestable scopes of a client
    *
    * Expected answers: code 204 : (Requestable scopes was successfully
    * deleted.) code 400 : Result () code 401 : Result () code 403 : Result ()
    * code 500 : Result ()
    *
  ...
  /** Get the requestable scopes per client
    *
    * Expected answers: code 200 : ClientExtensionRequestableScopesGetResponse
  ...
  /** Update requestable scopes of a client
    *
    * Expected answers: code 200 :
    * ClientExtensionRequestableScopesUpdateResponse code 400 : Result () code
