...
object ClientRegistrationUpdateRequest {
  ...
  given encoderClientRegistrationUpdateRequest
      : Encoder[ClientRegistrationUpdateRequest] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationUpdateRequest
      : Decoder[ClientRegistrationUpdateRequest] = Decoder
    .instance { c =>
      for {
