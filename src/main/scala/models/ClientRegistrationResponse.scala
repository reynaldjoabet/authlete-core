...
case class ClientRegistrationResponse(
    ...
    action: Option[ClientRegistrationResponseAction] = None,
...
object ClientRegistrationResponse {
  ...
  given jsonCodec: JsonValueCodec[ClientRegistrationResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientRegistrationResponse: Encoder[ClientRegistrationResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationResponse: Decoder[ClientRegistrationResponse] =
    Decoder.instance { c =>
      for {
