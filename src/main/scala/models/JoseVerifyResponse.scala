...
object JoseVerifyResponse {
  ...
  given jsonCodec: JsonValueCodec[JoseVerifyResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderJoseVerifyResponse: Encoder[JoseVerifyResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderJoseVerifyResponse: Decoder[JoseVerifyResponse] =
    Decoder.instance { c =>
      for {
