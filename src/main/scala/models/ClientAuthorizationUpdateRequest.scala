...
object ClientAuthorizationUpdateRequest {
  ...
  given encoderClientAuthorizationUpdateRequest
      : Encoder[ClientAuthorizationUpdateRequest] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientAuthorizationUpdateRequest
      : Decoder[ClientAuthorizationUpdateRequest] = Decoder
    .instance { c =>
      for {
