...
object AuthorizationFailRequest {
  ...
  given jsonCodec: JsonValueCodec[AuthorizationFailRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderAuthorizationFailRequest: Encoder[AuthorizationFailRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderAuthorizationFailRequest: Decoder[AuthorizationFailRequest] =
    Decoder.instance { c =>
      for {
