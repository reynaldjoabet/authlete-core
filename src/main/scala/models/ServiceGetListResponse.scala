...
object ServiceGetListResponse {
  ...
  given jsonCodec: JsonValueCodec[ServiceGetListResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderServiceGetListResponse: Encoder[ServiceGetListResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderServiceGetListResponse: Decoder[ServiceGetListResponse] =
    Decoder.instance { c =>
      for {
