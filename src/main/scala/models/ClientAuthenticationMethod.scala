...
/** The client authentication method that the client application declares that
  ...
  */
enum ClientAuthenticationMethod(val value: String)
    derives ConfiguredJsonValueCodec {

  case NONE extends ClientAuthenticationMethod("NONE")
  case CLIENTSECRETBASIC
      extends ClientAuthenticationMethod("CLIENT_SECRET_BASIC")
  ...
  case SELFSIGNEDTLSCLIENTAUTH
      extends ClientAuthenticationMethod("SELF_SIGNED_TLS_CLIENT_AUTH")

}

object ClientAuthenticationMethod {

  def withValueOpt(value: String): Option[ClientAuthenticationMethod] =
    ...
    withValueOpt(value).getOrElse(
      throw java.lang
        .IllegalArgumentException(
          s"ClientAuthenticationMethod enum case not found: $value"
        )
    )

  given decoderClientAuthenticationMethod: Decoder[ClientAuthenticationMethod] =
    Decoder.decodeString
      .map(withValue)

  given encoderClientAuthenticationMethod: Encoder[ClientAuthenticationMethod] =
