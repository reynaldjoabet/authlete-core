...
object TokenCreateResponse {
  ...
  given jsonCodec: JsonValueCodec[TokenCreateResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderTokenCreateResponse: Encoder[TokenCreateResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderTokenCreateResponse: Decoder[TokenCreateResponse] =
    Decoder.instance { c =>
      for {
        ...
        action <- mapEmptyStringToNull(c.downField("action"))
          .as[Option[TokenCreateResponseAction]]
