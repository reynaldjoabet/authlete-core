...
object FederationRegistrationRequest {
  ...
  given encoderFederationRegistrationRequest
      : Encoder[FederationRegistrationRequest] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderFederationRegistrationRequest
      : Decoder[FederationRegistrationRequest] = Decoder
    .instance { c =>
      for {
        entityConfiguration <- c
          .downField("entityConfiguration")
          .as[Option[String]]
