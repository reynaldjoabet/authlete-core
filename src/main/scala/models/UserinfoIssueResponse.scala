...
object UserinfoIssueResponse {
  ...
  given jsonCodec: JsonValueCodec[UserinfoIssueResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderUserinfoIssueResponse: Encoder[UserinfoIssueResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderUserinfoIssueResponse: Decoder[UserinfoIssueResponse] =
    Decoder.instance { c =>
      for {
        ...
        action <- mapEmptyStringToNull(c.downField("action"))
          .as[Option[UserinfoIssueResponseAction]]
