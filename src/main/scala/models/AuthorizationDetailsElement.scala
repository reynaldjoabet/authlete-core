...
object AuthorizationDetailsElement {
  ...
  given encoderAuthorizationDetailsElement
      : Encoder[AuthorizationDetailsElement] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderAuthorizationDetailsElement
      : Decoder[AuthorizationDetailsElement] =
    Decoder.instance { c =>
      for {
