...
object ClientAuthorizationGetListResponse {
  ...
  given encoderClientAuthorizationGetListResponse
      : Encoder[ClientAuthorizationGetListResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientAuthorizationGetListResponse
      : Decoder[ClientAuthorizationGetListResponse] =
    Decoder.instance { c =>
      for {
