...
/** @param resultCode
  ...
  *   This corresponds to the `client_notification_endpoint` metadata of the
  *   client application.
  * @param clientNotificationToken
  *   The client notification token which needs to be embedded as a Bearer token
  *   in the Authorization header in the notification. This is the value of the
...
object BackchannelAuthenticationCompleteResponse {
  ...
  given encoderBackchannelAuthenticationCompleteResponse
      : Encoder[BackchannelAuthenticationCompleteResponse] = Encoder.instance {
    t =>
      Json.fromFields {
        Seq(
          ...
          t.clientNotificationEndpoint.map(v =>
            "clientNotificationEndpoint" -> v.asJson
          ),
  ...
  given decoderBackchannelAuthenticationCompleteResponse
      : Decoder[BackchannelAuthenticationCompleteResponse] = Decoder.instance {
    c =>
      for {
        ...
        clientNotificationEndpoint <- c
          .downField("clientNotificationEndpoint")
          .as[Option[String]]
