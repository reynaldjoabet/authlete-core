...
/** @param resultCode
  ...
  *   The response content that can be used as the message body of the token
  *   response that should be returned from the token endpoint.
  * @param idToken
...
object IdtokenReissueResponse {
  ...
  given jsonCodec: JsonValueCodec[IdtokenReissueResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderIdtokenReissueResponse: Encoder[IdtokenReissueResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderIdtokenReissueResponse: Decoder[IdtokenReissueResponse] =
    Decoder.instance { c =>
      for {
        ...
        action <- mapEmptyStringToNull(c.downField("action"))
          .as[Option[IdtokenReissueResponseAction]]
