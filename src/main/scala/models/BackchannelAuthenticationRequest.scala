...
object BackchannelAuthenticationRequest {
  ...
  given encoderBackchannelAuthenticationRequest
      : Encoder[BackchannelAuthenticationRequest] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderBackchannelAuthenticationRequest
      : Decoder[BackchannelAuthenticationRequest] = Decoder
    .instance { c =>
      for {
