...
object ClientRegistrationDeleteRequest {
  ...
  given encoderClientRegistrationDeleteRequest
      : Encoder[ClientRegistrationDeleteRequest] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationDeleteRequest
      : Decoder[ClientRegistrationDeleteRequest] = Decoder
    .instance { c =>
      for {
