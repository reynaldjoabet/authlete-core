...
object HskCreateResponse {
  ...
  given jsonCodec: JsonValueCodec[HskCreateResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderHskCreateResponse: Encoder[HskCreateResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderHskCreateResponse: Decoder[HskCreateResponse] =
    Decoder.instance { c =>
      for {
