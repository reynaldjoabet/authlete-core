...
object ClientSecretRefreshResponse {
  ...
  given encoderClientSecretRefreshResponse
      : Encoder[ClientSecretRefreshResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientSecretRefreshResponse
      : Decoder[ClientSecretRefreshResponse] =
    Decoder.instance { c =>
      for {
