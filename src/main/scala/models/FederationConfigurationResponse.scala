...
object FederationConfigurationResponse {
  ...
  given encoderFederationConfigurationResponse
      : Encoder[FederationConfigurationResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderFederationConfigurationResponse
      : Decoder[FederationConfigurationResponse] = Decoder
    .instance { c =>
      for {
