...
/** @param resultCode
  ...
  *   `action` parameter. See description for details.
  */
case class TokenFailResponse(
    resultCode: Option[String] = None,
    resultMessage: Option[String] = None,
    action: Option[TokenFailResponseAction] = None,
    responseContent: Option[String] = None
)

object TokenFailResponse {

  given jsonCodec: JsonValueCodec[TokenFailResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderTokenFailResponse: Encoder[TokenFailResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderTokenFailResponse: Decoder[TokenFailResponse] =
    Decoder.instance { c =>
      for {
