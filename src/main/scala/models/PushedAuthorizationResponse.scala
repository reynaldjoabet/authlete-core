...
/** @param resultCode
  ...
  * @param action
  * @param requestUri
  *   The request_uri created to the client to be used as request_uri on the
  *   authorize call.
...
object PushedAuthorizationResponse {
  ...
  given encoderPushedAuthorizationResponse
      : Encoder[PushedAuthorizationResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderPushedAuthorizationResponse
      : Decoder[PushedAuthorizationResponse] =
    Decoder.instance { c =>
      for {
        ...
        action <-
          mapEmptyStringToNull(c.downField("action"))
            .as[Option[PushedAuthorizationResponseAction]]
