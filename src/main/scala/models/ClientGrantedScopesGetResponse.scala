...
/** @param resultCode
  ...
  *   The client ID.
  * @param subject
  *   the subject (= unique identifier) of the user who has granted
  ...
  *   process by the user (who is identified by the subject). <p> `null` means
  *   that there is no record about granted scopes. An empty array means that
  *   there exists a record about granted scopes but no scope has been granted
  *   to the client application. If the returned array holds some elements, they
  *   are the scopes granted to the client application by the last authorization
  *   process. </p>
  ...
  * @param modifiedAt
  *   Get the timestamp in milliseconds since Unix epoch at which this record
  *   was modified.
  */
...
object ClientGrantedScopesGetResponse {
  ...
  given encoderClientGrantedScopesGetResponse
      : Encoder[ClientGrantedScopesGetResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientGrantedScopesGetResponse
      : Decoder[ClientGrantedScopesGetResponse] = Decoder
    .instance { c =>
      for {
        ...
        latestGrantedScopes <- c
          .downField("latestGrantedScopes")
          .as[Option[Seq[String]]]
        mergedGrantedScopes <- c
          .downField("mergedGrantedScopes")
          .as[Option[Seq[String]]]
