...
object TokenFailRequest {
  ...
  given jsonCodec: JsonValueCodec[TokenFailRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderTokenFailRequest: Encoder[TokenFailRequest] = Encoder.instance {
    t =>
      Json.fromFields {
        Seq(
  ...
  given decoderTokenFailRequest: Decoder[TokenFailRequest] = Decoder.instance {
    c =>
      for {
