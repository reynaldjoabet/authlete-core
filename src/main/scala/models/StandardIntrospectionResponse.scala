...
object StandardIntrospectionResponse {
  ...
  given encoderStandardIntrospectionResponse
      : Encoder[StandardIntrospectionResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderStandardIntrospectionResponse
      : Decoder[StandardIntrospectionResponse] = Decoder
    .instance { c =>
      for {
