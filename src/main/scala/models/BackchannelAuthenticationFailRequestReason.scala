...
enum BackchannelAuthenticationFailRequestReason(val value: String)
  ...
  case UNAUTHORIZEDCLIENT
      extends BackchannelAuthenticationFailRequestReason("UNAUTHORIZED_CLIENT")
  case UNKNOWNUSERID
...
object BackchannelAuthenticationFailRequestReason {
  ...
  def withValueOpt(
      value: String
  ): Option[BackchannelAuthenticationFailRequestReason] =
  ...
  given decoderBackchannelAuthenticationFailRequestReason
      : Decoder[BackchannelAuthenticationFailRequestReason] =
    Decoder.decodeString.map(withValue)

  given encoderBackchannelAuthenticationFailRequestReason
      : Encoder[BackchannelAuthenticationFailRequestReason] =
