...
object UserinfoRequest {
  ...
  given jsonCodec: JsonValueCodec[UserinfoRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderUserinfoRequest: Encoder[UserinfoRequest] = Encoder.instance {
    t =>
      Json.fromFields {
        Seq(
  ...
  given decoderUserinfoRequest: Decoder[UserinfoRequest] = Decoder.instance {
    c =>
      for {
