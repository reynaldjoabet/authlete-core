...
object UserinfoResponse {
  ...
  given jsonCodec: JsonValueCodec[UserinfoResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderUserinfoResponse: Encoder[UserinfoResponse] = Encoder.instance {
    t =>
      Json.fromFields {
        Seq(
  ...
  given decoderUserinfoResponse: Decoder[UserinfoResponse] = Decoder.instance {
    c =>
      for {
