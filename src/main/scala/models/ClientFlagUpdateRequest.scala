...
object ClientFlagUpdateRequest {
  ...
  given jsonCodec: JsonValueCodec[ClientFlagUpdateRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientFlagUpdateRequest: Encoder[ClientFlagUpdateRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientFlagUpdateRequest: Decoder[ClientFlagUpdateRequest] =
    Decoder.instance { c =>
      for {
