...
/** @param ticket
  ...
  *   is `application/json`, so don't use `application/x-www-form-urlencoded` if
  *   you want to specify properties.
  * @param jwtAtClaims
...
object TokenIssueRequest {
  ...
  given jsonCodec: JsonValueCodec[TokenIssueRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderTokenIssueRequest: Encoder[TokenIssueRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderTokenIssueRequest: Decoder[TokenIssueRequest] =
    Decoder.instance { c =>
      for {
