...
object HskDeleteResponse {
  ...
  given jsonCodec: JsonValueCodec[HskDeleteResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderHskDeleteResponse: Encoder[HskDeleteResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderHskDeleteResponse: Decoder[HskDeleteResponse] =
    Decoder.instance { c =>
      for {
