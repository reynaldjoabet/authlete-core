...
/** @param developer
  *   The developer of the client applications. If the request did not contain
  *   `developer` request parameter, this property is set to `null`.
  * @param start
  *   Start index (inclusive) of the result set of the query.
  * @param end
  *   End index (exclusive) of the result set of the query.
  * @param totalCount
  *   Total number of clients that belong to the service. This doesn't mean the
  *   number of clients contained in the response.
  * @param clients
  *   An array of clients.
  */
...
object ClientGetListResponse {
  ...
  given jsonCodec: JsonValueCodec[ClientGetListResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientGetListResponse: Encoder[ClientGetListResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientGetListResponse: Decoder[ClientGetListResponse] =
    Decoder.instance { c =>
      for {
