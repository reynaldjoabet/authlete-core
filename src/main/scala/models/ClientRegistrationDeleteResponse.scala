...
/** @param resultCode
  ...
  * @param client
  */
case class ClientRegistrationDeleteResponse(
    resultCode: Option[String] = None,
    resultMessage: Option[String] = None,
    action: Option[ClientRegistrationDeleteResponseAction] = None,
...
object ClientRegistrationDeleteResponse {
  ...
  given jsonCodec: JsonValueCodec[ClientRegistrationDeleteResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientRegistrationDeleteResponse
      : Encoder[ClientRegistrationDeleteResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationDeleteResponse
      : Decoder[ClientRegistrationDeleteResponse] = Decoder
    .instance { c =>
      for {
