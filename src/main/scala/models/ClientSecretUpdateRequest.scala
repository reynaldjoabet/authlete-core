...
object ClientSecretUpdateRequest {
  ...
  given jsonCodec: JsonValueCodec[ClientSecretUpdateRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientSecretUpdateRequest: Encoder[ClientSecretUpdateRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientSecretUpdateRequest: Decoder[ClientSecretUpdateRequest] =
    Decoder.instance { c =>
      for {
