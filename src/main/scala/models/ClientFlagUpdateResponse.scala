...
object ClientFlagUpdateResponse {
  ...
  given jsonCodec: JsonValueCodec[ClientFlagUpdateResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientFlagUpdateResponse: Encoder[ClientFlagUpdateResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientFlagUpdateResponse: Decoder[ClientFlagUpdateResponse] =
    Decoder.instance { c =>
      for {
