...
/** @param userCode
  ...
  *   authorization request with. When nothing is specified for this parameter,
...
object DeviceCompleteRequest {
  ...
  given jsonCodec: JsonValueCodec[DeviceCompleteRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderDeviceCompleteRequest: Encoder[DeviceCompleteRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderDeviceCompleteRequest: Decoder[DeviceCompleteRequest] =
    Decoder.instance { c =>
      for {
