...
/** @param resultCode
  ...
  */
case class ClientSecretUpdateResponse(
...
object ClientSecretUpdateResponse {
  ...
  given jsonCodec: JsonValueCodec[ClientSecretUpdateResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientSecretUpdateResponse: Encoder[ClientSecretUpdateResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientSecretUpdateResponse: Decoder[ClientSecretUpdateResponse] =
    Decoder.instance { c =>
      for {
      ...
      } yield ClientSecretUpdateResponse(
