...
object BackchannelAuthenticationCompleteRequest {
  ...
  given jsonCodec: JsonValueCodec[BackchannelAuthenticationCompleteRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderBackchannelAuthenticationCompleteRequest
      : Encoder[BackchannelAuthenticationCompleteRequest] = Encoder.instance {
    t =>
      Json.fromFields {
        Seq(
  ...
  given decoderBackchannelAuthenticationCompleteRequest
      : Decoder[BackchannelAuthenticationCompleteRequest] = Decoder.instance {
    c =>
      for {
        ticket <- c.downField("ticket").as[String]
        result <- c
          .downField("result")
          .as[BackchannelAuthenticationCompleteRequestResult]
      ...
      } yield BackchannelAuthenticationCompleteRequest(
        ticket = ticket,
        result = result,
        subject = subject,
        sub = sub,
