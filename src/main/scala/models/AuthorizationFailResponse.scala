...
object AuthorizationFailResponse {
  ...
  given jsonCodec: JsonValueCodec[AuthorizationFailResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderAuthorizationFailResponse: Encoder[AuthorizationFailResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderAuthorizationFailResponse: Decoder[AuthorizationFailResponse] =
    Decoder.instance { c =>
      for {
        ...
        action <-
          mapEmptyStringToNull(c.downField("action"))
            .as[Option[AuthorizationFailResponseAction]]
        responseContent <- c.downField("responseContent").as[Option[String]]
      } yield AuthorizationFailResponse(
