...
object ClientRegistrationRequest {
  ...
  given jsonCodec: JsonValueCodec[ClientRegistrationRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientRegistrationRequest: Encoder[ClientRegistrationRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationRequest: Decoder[ClientRegistrationRequest] =
    Decoder.instance { c =>
      for {
