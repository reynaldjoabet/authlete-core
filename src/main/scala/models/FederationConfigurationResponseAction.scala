...
object FederationConfigurationResponseAction {
  ...
  def withValueOpt(
      value: String
  ): Option[FederationConfigurationResponseAction] =
  ...
  given decoderFederationConfigurationResponseAction
      : Decoder[FederationConfigurationResponseAction] =
    Decoder.decodeString.map(withValue)

  given encoderFederationConfigurationResponseAction
      : Encoder[FederationConfigurationResponseAction] = Encoder.encodeString
