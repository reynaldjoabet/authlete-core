...
object AuthorizationRequest {
  ...
  given jsonCodec: JsonValueCodec[AuthorizationRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderAuthorizationRequest: Encoder[AuthorizationRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderAuthorizationRequest: Decoder[AuthorizationRequest] =
    Decoder.instance { c =>
      for {
