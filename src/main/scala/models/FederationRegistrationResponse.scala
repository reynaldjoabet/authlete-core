...
object FederationRegistrationResponse {
  ...
  given encoderFederationRegistrationResponse
      : Encoder[FederationRegistrationResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderFederationRegistrationResponse
      : Decoder[FederationRegistrationResponse] = Decoder
    .instance { c =>
      for {
