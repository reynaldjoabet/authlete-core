...
object DeviceCompleteResponse {
  ...
  given jsonCodec: JsonValueCodec[DeviceCompleteResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderDeviceCompleteResponse: Encoder[DeviceCompleteResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderDeviceCompleteResponse: Decoder[DeviceCompleteResponse] =
    Decoder.instance { c =>
      for {
        ...
        action <- mapEmptyStringToNull(c.downField("action"))
          .as[Option[DeviceCompleteResponseAction]]
