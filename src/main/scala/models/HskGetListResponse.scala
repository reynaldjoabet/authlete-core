...
object HskGetListResponse {
  ...
  given jsonCodec: JsonValueCodec[HskGetListResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderHskGetListResponse: Encoder[HskGetListResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderHskGetListResponse: Decoder[HskGetListResponse] =
    Decoder.instance { c =>
      for {
        ...
        action <- mapEmptyStringToNull(c.downField("action"))
          .as[Option[HskGetListResponseAction]]
