...
case class RevocationResponse(
    ...
    action: Option[RevocationResponseAction] = None,
    responseContent: Option[String] = None
)

object RevocationResponse {

  given jsonCodec: JsonValueCodec[RevocationResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderRevocationResponse: Encoder[RevocationResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderRevocationResponse: Decoder[RevocationResponse] =
    Decoder.instance { c =>
      for {
