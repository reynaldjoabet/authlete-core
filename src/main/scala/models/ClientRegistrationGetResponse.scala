...
object ClientRegistrationGetResponse {
  ...
  given encoderClientRegistrationGetResponse
      : Encoder[ClientRegistrationGetResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationGetResponse
      : Decoder[ClientRegistrationGetResponse] = Decoder
    .instance { c =>
      for {
