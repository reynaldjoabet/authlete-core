...
object TokenGetListResponse {
  ...
  given jsonCodec: JsonValueCodec[TokenGetListResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderTokenGetListResponse: Encoder[TokenGetListResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderTokenGetListResponse: Decoder[TokenGetListResponse] =
    Decoder.instance { c =>
      for {
