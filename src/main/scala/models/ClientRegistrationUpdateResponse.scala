...
/** @param resultCode
  ...
  * @param client
  */
case class ClientRegistrationUpdateResponse(
    resultCode: Option[String] = None,
    resultMessage: Option[String] = None,
    action: Option[ClientRegistrationUpdateResponseAction] = None,
...
object ClientRegistrationUpdateResponse {
  ...
  given jsonCodec: JsonValueCodec[ClientRegistrationUpdateResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderClientRegistrationUpdateResponse
      : Encoder[ClientRegistrationUpdateResponse] = Encoder
    .instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderClientRegistrationUpdateResponse
      : Decoder[ClientRegistrationUpdateResponse] = Decoder
    .instance { c =>
      for {
