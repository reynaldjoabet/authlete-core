...
object AttachmentType {
  ...
  def withValueOpt(value: String): Option[AttachmentType] =
  ...
  def withValue(value: String): AttachmentType =
    withValueOpt(value).getOrElse(
      throw java.lang.IllegalArgumentException(
        s"AttachmentType enum case not found: $value"
      )
    )

  given decoderAttachmentType: Decoder[AttachmentType] =
    Decoder.decodeString.map(withValue)

  given encoderAttachmentType: Encoder[AttachmentType] = Encoder.encodeString
