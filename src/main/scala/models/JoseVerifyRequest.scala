...
object JoseVerifyRequest {
  ...
  given jsonCodec: JsonValueCodec[JoseVerifyRequest] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderJoseVerifyRequest: Encoder[JoseVerifyRequest] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderJoseVerifyRequest: Decoder[JoseVerifyRequest] =
    Decoder.instance { c =>
      for {
