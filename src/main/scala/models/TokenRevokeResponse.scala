...
object TokenRevokeResponse {
  ...
  given jsonCodec: JsonValueCodec[TokenRevokeResponse] =
    JsonCodecMaker.make(codecMakerConfig)

  given encoderTokenRevokeResponse: Encoder[TokenRevokeResponse] =
    Encoder.instance { t =>
      Json.fromFields {
        Seq(
  ...
  given decoderTokenRevokeResponse: Decoder[TokenRevokeResponse] =
    Decoder.instance { c =>
      for {
